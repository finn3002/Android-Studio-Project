...
public class AddActivity2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mydatas.add(new Mydata(500,500,500));
        mydatas.add(new Mydata(50,50,50));
        mydatas.add(new Mydata(20,80,50));
        findview();
        //recyclerView Set
//        settingRecycleV();
        settingRecycleV2();
//        getFood(recyclerView);
        Log.e("testdata",String.valueOf(mydatas.size()));
    ...
    private void findview(){
        ...
        tablebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AddActivity2.this,Analysis.class);
                startActivity(intent);
            }
        });
        ...
        foodbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AddActivity2.this,Food.class);
                startActivity(intent);
            }
        });
        ...
        profilebutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AddActivity2.this,PageActivity.class);
                startActivity(intent);
            }
        });
        ...
        chatbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AddActivity2.this,Chat.class);
                startActivity(intent);
            }
        });
...
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(AddActivity2.this,AddDetail.class);
//                startActivity(intent);
//            }
//        });
    ...
    private void settingRecycleV2(){
//        ViewPager2 viewPager2 = findViewById(R.id.view_pager);
        MyAdapter2 myAdapter2 = new MyAdapter2(mydatas);
        viewPage.setAdapter(myAdapter2);
